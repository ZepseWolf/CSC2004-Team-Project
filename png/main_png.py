...
from png import header				# import header.py file
from png import file					# import file.py file
from png import body					# import body.py
...
def main():
	...
	# exit_flag = encodeMain('italy_medium.jpg', secret_string, True, True, 2)
	# exit_flag = encodeMain('rgb.png', secret_string, True, False, 2)		# isTextBox -> True
	# exit_flag = encodeMain('taylor.jpg', txtfilepath, False, False, 2)		# isTextBox -> False
	...
	'''
	# txtfilename, secret_type, secret_str = decodeMain('rgb_encoded.png')
	# if txtfilename:
